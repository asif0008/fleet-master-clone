                ...
                <Stack sx={{gap:'2px'}}>
                  ...
                  <Stack direction='row' alignItems='center' sx={{gap:'4px'}}>
                        {card.subtitleOneTxt === 'Critical' && 
                            <Box sx={{width:'8px', height:'8px', borderRadius:'50%', background:'#ff6454'}}></Box>
                        }
                        {card.subtitleOneTxt === 'Idle' && (
                            <Box sx={{width:'8px', height:'8px', borderRadius:'50%', background:'#969696'}}></Box>
                        )}
                        <Typography
                            variant="h6"
                            sx={{
                ...
                <Stack sx={{gap:'2px'}}>
                  ...
                  <Stack direction='row' alignItems='center' sx={{gap:'4px'}}>
                    {card.subtitleTwoTxt === 'Overdue' && (
                        <Box sx={{width:'8px', height:'8px', borderRadius:'50%', background:'#edec0b'}}></Box>
                    )}
                    <Typography
                        variant="h6"
                        sx={{
